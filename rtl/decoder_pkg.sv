package decoder_pkg;
  ...
  localparam LOAD_TYPE  = 4'b0010;
  localparam STORE_TYPE = 4'b0011;
  localparam B_TYPE     = 4'b0100;
  localparam J_TYPE     = 4'b0101;
  localparam U_TYPE     = 4'b0110;
  localparam S_TYPE     = 4'b0111;
  localparam ILLEGAL    = 4'b1000;
